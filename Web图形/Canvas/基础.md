...
![Canvas栅格](../../Img/Web图形/canvas/canvas_grid.png)
...
![canvas绘制矩形](../../Img/Web图形/canvas/canvas_矩形.png)
...
```js
  ...
  ctx.fill();
```
![Canvas路径](../../Img/Web图形/canvas/canvas_路径.png)
...
![Canvas_贝塞尔.png](../../Img/Web图形/canvas/canvas_贝塞尔.png)
...
ctx.stroke();
```
![canvas颜色](../../Img/Web图形/canvas/canvas_颜色.png)
...
ctx.globalAlpha = 0.2;
```
![canvas不透明度](../../Img/Web图形/canvas/canvas_不透明度.png)
...
```
![渐变](../../Img/Web图形/canvas/canvas_渐变.png)
...
```
![canvas阴影](../../Img/Web图形/canvas/canvas_阴影.png)
...
![canvas线](../../Img/Web图形/canvas/canvas_线.png)

3. `lineJoin`：线条与线条链接处样式，可能值：`round`，`bevel` 和 `miter`（默认）。

![canvas不透明度](../../Img/Web图形/canvas/canvas_链接.png)

### 虚线

1. `setLineDash`：该方法接收一个数组，来指定**线段**与**间隙**的长度

![canvas虚线](../../Img/Web图形/canvas/canvas_虚线.png)
